...
Замечание к конфигурационному файлу, поскольку по умолчанию скрипт устанавливает MTU = 1270 (что меньше минимума 1280 для IPv6) 
все связанное с IPv6 игнорируется. Для MIPS/MIPSEL устройств это гарантирует куда более стабильную работу.
---
